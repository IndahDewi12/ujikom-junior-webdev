...
@push('js')
    ...
    <script>
        ...
        function editUser() {
            let url = "{{ route('api.pegawai.update', ':pegawaiId') }}";
            url = url.replace(':pegawaiId', userId);
        ...
        function deleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "{{ route('api.pegawai.destroy', ':pegawaiId') }}";
                    url = url.replace(':pegawaiId', userId);
                    $.post(url, {
                            _method: 'DELETE'
                        })
        ...
        function openEditModal(id) {
            ...
            let url = `{{ route('api.pegawai.show', ':pegawaiId') }}`;
            url = url.replace(':pegawaiId', userId);
